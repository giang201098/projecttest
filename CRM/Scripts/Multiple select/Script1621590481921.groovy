...
WebUI.click(findTestObject('Page_dev - Leads/li_S in thoi_select2-search-field'))

WebUI.click(findTestObject('Page_dev - Leads/div_Me va be'))

WebUI.click(findTestObject('Page_dev - Leads/div_My pham'))

WebUI.click(findTestObject('Page_dev - Leads/button_Search'))
