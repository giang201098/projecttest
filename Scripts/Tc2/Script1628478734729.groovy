...
WebUI.openBrowser('https://cpanel-shipping.kvpos.com:64913/')

WebUI.setText(findTestObject('Page_Kiotviet Giao Van/input_KiotViet_email'), 'admin@occ.com')

WebUI.setText(findTestObject('Page_Kiotviet Giao Van/input_KiotViet_password'), '123456')
